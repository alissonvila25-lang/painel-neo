...
THRESHOLDS: dict[str, float] = {
    ...
    "peso_ramp_frac":      0.6,    # subida max por rodada
    "peso_ramp_down_frac": 0.8,    # queda max por rodada (correcao mais rapida)
    "peso_ramp_min":       3,
    "peso_teto_frac":      2.0,
    "peso_expoente":       1.2,
    "conv_med_frac":       0.70,
    "disp_zerada_pct":     2.0,    # disponivel% abaixo disso → peso sugerido = 0
}
